...
class SolverSpec extends AnyFlatSpec with Matchers {
  ...
  it should "work with my 'ultimate' example" in {
    process(
      "KcQcJcTcTs Ac2c 2cAc 9c2s 2s9c TdTh ThTd TdKd KdTd 3c4s 4s3c 9s2d 2d9s Td3d 3dTd 5c5s 5s5c 2d3d 3d2d"
    ) shouldEqual "2d3d=3d2d 3dTd=Td3d 2d9s=9s2d 3c4s=4s3c 5c5s=5s5c KdTd=TdKd TdTh=ThTd 2s9c=9c2s 2cAc=Ac2c"
  }
  ...
  it should "Random Test 5" in {
    process("Ad5dQh4hQc 8d9h 2dJh") shouldEqual "8d9h 2dJh"
  }
